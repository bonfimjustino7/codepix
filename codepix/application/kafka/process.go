...
import (
	...
	"github/bonfimjustino7/codepix-go/application/factory"
	appmodel "github/bonfimjustino7/codepix-go/application/model"
	"github/bonfimjustino7/codepix-go/application/usecase"
	"github/bonfimjustino7/codepix-go/domain/model"
...
func NewKafkaProcessor(datbase *gorm.DB, producer *ckafka.Producer, deliveryChan chan ckafka.Event) *KafkaProcessor {
...
func (k *KafkaProcessor) processMessage(msg *ckafka.Message) {
	...
	transacationConfirmationTopic := "transaction_confirmation"

	switch topic := *msg.TopicPartition.Topic; topic {
	case transactionsTopic:
		k.processTransaction(msg)
	case transacationConfirmationTopic:
...
func (k *KafkaProcessor) processTransaction(msg *ckafka.Message) error {
	...
	if err != nil {
		fmt.Println("error regirering transaction", err)
		return err
	}
